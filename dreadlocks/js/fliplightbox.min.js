...
var flb_settings = $.extend({
        ...
        lightbox_text_style: 'font-size: 16px; line-height: 1.4; color: #000000; text-align: center;',
        
        lightbox_text_anchor_link_style: 'text-decoration: underline; color: #000000;',
    
        lightbox_text_background_style: 'background-color: #FFD700; opacity:0.8;',
